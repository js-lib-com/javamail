...
/**
 * Immutable RFC2822 message identifier. This is a unique message identifier that refers to a particular version of a particular
 * message. It is structured as bellow:
 * 
 * <pre>
...
public final class MessageID implements Serializable {
	 ...
	 * parameter starts with angular bracket it should be a valid RFC2822 message ID, otherwise syntax exception is thrown. If
	 * not, it is considered message right part and for left part uses a generated UUID.
	 * 
	...
	public boolean equals(Object obj) {
		...
		if (this.idLeft == null) {
			if (other.idLeft != null)
				return false;
		} else if (!this.idLeft.equals(other.idLeft))
			return false;
		if (this.idRight == null) {
			if (other.idRight != null)
				return false;
		} else if (!this.idRight.equals(other.idRight))
			return false;
		return true;
	}
